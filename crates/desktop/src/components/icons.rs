...
pub const BWI_ARCHIVE: BwiIcon = BwiIcon('\u{f168}');
pub const BWI_TRASH: BwiIcon = BwiIcon('\u{f14b}');
pub const BWI_ANGLE_LEFT: BwiIcon = BwiIcon('\u{f16c}');
pub const BWI_ANGLE_RIGHT: BwiIcon = BwiIcon('\u{f16b}');
pub const BWI_ANGLE_DOWN: BwiIcon = BwiIcon('\u{f16d}');
pub const BWI_ANGLE_UP: BwiIcon = BwiIcon('\u{f169}');
